...
function calc() {
  ...
  calcTotal();
  function initialLocalStorage(selector, activeClass) {
  ...
  initialLocalStorage('#gender div', 'calculating__choose-item_active');
  initialLocalStorage('.calculating__choose_big div', 'calculating__choose-item_active');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _services_servieces__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/servieces */ "./js/modules/services/servieces.js");
...
function card() {
  ...
  (0,_services_servieces__WEBPACK_IMPORTED_MODULE_0__.getResources)('http://localhost:3000/menu').then(data => createCard(data));
...
/* harmony import */ var _services_servieces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/servieces */ "./js/modules/services/servieces.js");
...
function form(formSelector, timerModalId) {
  ...
  function sendData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_servieces__WEBPACK_IMPORTED_MODULE_1__.postData)("http://localhost:3000/requests", json).then(data => {
        console.log(data);
...
/***/ "./js/modules/services/servieces.js":
/*!******************************************!*\
  !*** ./js/modules/services/servieces.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_calculate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/calculate */ "./js/modules/calculate.js");
...
window.addEventListener('DOMContentLoaded', () => {
  const timerModalId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', timerModalId), 50000);
  (0,_modules_card__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_0__["default"])('.timer', '2024-12-20');
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])('form', timerModalId);
